		...
		>
			...
			>
				<div className="flex h-full justify-center items-center bg-deep-blue">
					<h2 className="font-yellowtail text-5xl sm:text-6xl px-[20px] pr-[30px] bg-deep-blue">
						Certificates
					</h2>
				</div>
			</motion.div>
			<div className="flex h-4/6 justify-center items-center">
				<div className="flex flex-wrap justify-center items-start w-full h-full mb-5 gap-10">
					...
					>
						<Certificate
							img={CJs}
							alt={"Curso Javascript - CoderHouse"}
							setSelectedCer={setSelectedCer}
			...
			<div
				className={`${
					isModalActive ? "flex" : "hidden"
				} fixed top-0 left-0 z-50 w-screen h-screen bg-black/70 justify-center items-center`}
			>
				<a
				...
				<div className="overflow-x-auto snap-x">
					<div className="w-full snap-center">
						<img
							src={selectedCer}
							alt=""
							className=" max-w-[700px] md:max-w-[900px] max-h-[600px] object-cover"
						/>
					</div>
				</div>
			</div>

...
const DotGroup = ({ selectedPage, setSelectedPage}) => {
    const selectedStyles = `relative bg-amber before:absolute before:w-6 before:h-6 
    before:rounded-full before:border-2 before:border-amber before:left-[-50%] before:top-[-50%]`;
